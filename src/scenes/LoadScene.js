...
import liveitem from  "../assets/liveitem.png";
import flyingbird from "../assets/flyingbird.png";
...
export default class LoadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet("flyingbird", flyingbird, {
      frameWidth: 180,
      frameHeight: 180,
      startFrame: 0,
      endFrame: 8,
    ...
    this.load.image("liveitem", liveitem);
